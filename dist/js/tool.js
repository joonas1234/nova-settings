...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__UpdateModal__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__UpdateModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__UpdateModal__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        UpdateModal: __WEBPACK_IMPORTED_MODULE_2__UpdateModal___default.a
    },
    created: function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            return _context.abrupt('return', __WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */].getSettings().then(function (settings) {
    ...
    methods: {
        openEditModal: function openEditModal(key, value) {
        ...
        updateSetting: function updateSetting(data) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */].updateSetting(data).then(function (editedSetting) {
                _this2.closeEditModal();
                _this2.settings[editedSetting.key] = editedSetting.value;
            });
        }
    }
  ...
  return _c("loading-view", { attrs: { loading: _vm.loading } }, [
    _c(
      ...
      [
                                  ...
                                  "button",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.openEditModal(key, value)
                                      }
                                    }
                                  },
                                  [
        ...
        _vm.updateModalOpen
          ? _c("update-modal", {
              attrs: { data: _vm.editingSetting },
              on: { update: _vm.updateSetting, cancel: _vm.closeEditModal }
            })
          : _vm._e()
      ],
      1
...
/* harmony default export */ __webpack_exports__["a"] = ({
    getSettings: function getSettings() {
        return window.axios.get("/nova-vendor/nova-settings/settings").then(function (response) {
            return response.data;
        });
    },
    updateSetting: function updateSetting(data) {
        return window.axios.post("/nova-vendor/nova-settings/settings", data).then(function (response) {
            return response.data;
        });
    }
});
...
Component.options.__file = "resources/js/components/UpdateModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-986adf6e", Component.options)
  } else {
    hotAPI.reload("data-v-986adf6e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "modal select-none fixed pin z-50 overflow-x-hidden overflow-y-auto text-left",
          ...
          _c(
            ...
            [
              _c(
                ...
                [_vm._v(_vm._s(_vm.__("Update setting")))]
              ),
              _vm._v(" "),
                ...
                _c("div", { staticClass: "flex items-center ml-auto" }, [
                  _c(
                    "button",
                    {
                      ...
                      attrs: { disabled: _vm.submitting, type: "button" },
                      on: {
                        click: function($event) {
                          $event.preventDefault()
                  ...
                  _c(
                    ...
                    [_c("span", [_vm._v(_vm._s(_vm.__("Update")))])]
                  )
                ])
              ])
            ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-986adf6e", module.exports)
  }
}
